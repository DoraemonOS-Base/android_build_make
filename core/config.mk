...
ifeq (,$(strip $(PDK_FUSION_PLATFORM_ZIP)$(PDK_FUSION_PLATFORM_DIR)))
  ...
  _pdk_fusion_search_paths := \
    ...
    vendor/pdk/$(TARGET_DEVICE)/$(patsubst doraemon_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform \
    vendor/pdk/$(TARGET_PRODUCT)/$(TARGET_PRODUCT)-$(TARGET_BUILD_VARIANT)/platform \
    vendor/pdk/$(TARGET_PRODUCT)/$(patsubst doraemon_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform
...
ifneq ($(DORAEMON_BUILD),)
ifneq ($(wildcard device/doraemon/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/doraemon/sepolicy/common/sepolicy.mk)
endif
endif
